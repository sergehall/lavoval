...
func New() (*Application, error) {
	...
	authService := service.NewAuthService(userRepo, profileRepo, verificationRepo, passwordResetRepo, tokenManager, verificationMailer, service.NoopSessionRevoker{}, cfg)
